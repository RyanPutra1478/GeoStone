...
Mohon informasi mengenai ketersediaan dan penawaran harga.`
    ...
    const waUrl = `https://wa.me/6285340305572?text=${encodeURIComponent(text)}`
  ...
  const commodities = [
    {
      ...
      grade: 'Material Konstruksi',
      desc: 'Batu galian berstandar struktural yang ideal dan vital untuk fondasi infrastruktur prasarana, jalur rel, dan pembangunan properti tingkat tinggi.',
      status: 'Tersedia',
    },
    {
      icon: (
      ...
      title: 'Pasir Tanah & Sirtu',
      grade: 'Material Urugan',
      desc: 'Material tambang galian C alami dalam skala besar untuk keperluan reklamasi daratan luas, formasi base tanah, atau pemadatan lapangan.',
      status: 'Tersedia',
    },
  ]
    ...
    <div className="page page--trade">
      ...
      <section className="page-hero">
        ...
        <div className="page-hero__content container">
          <span className="page-hero__badge">Perdagangan Mineral</span>
        ...
        <div className="container">
          ...
          <div className="tp-products__grid">
            {productsForSale.map((product) => (
              <div className="tp-product-card" key={product.id}>
      ...
      <section className="tp-commodities">
        <div className="container">
          <div className="tp-commodities__header">
            <span className="section-badge">Komoditas Kami</span>
            <h2 className="section-title">Mineral yang Kami <span className="tp-accent">Tambang</span></h2>
            <p className="section-subtitle" style={{ margin: '0 auto' }}>
              Lihat ragam sumber daya unggulan yang tersedia saat ini dan rencana pengembangan tambang kami ke depan.
            </p>
          </div>
      ...
      <section className="tp-features">
        <div className="container">
          <div className="tp-features__header">
            ...
            <h2 className="section-title">Mengapa Bermitra Dengan <span className="tp-accent">GeoStone</span></h2>
          </div>
