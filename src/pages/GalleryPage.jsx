...
const categories = ['Semua', 'Gambar', 'Video']
      ...
      <div className="page page--gallery">
        ...
        <section className="page-hero">
          ...
          <div className="page-hero__content container">
            <span className="page-hero__badge reveal delay-100">Portofolio Kami</span>
            <h1 className="page-hero__title reveal delay-200">Galeri Proyek</h1>
            <p className="page-hero__desc reveal delay-300">
              Jelajahi portofolio proyek pertambangan kami yang telah selesai maupun yang sedang berjalan di seluruh Indonesia.
            </p>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="gp-gallery__grid">
              {filteredProjects.map((project, i) => (
                <div
                  className="gp-gallery__item reveal reveal--scale"
                  key={`${project.title}-${i}`}
